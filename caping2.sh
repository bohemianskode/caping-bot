...
oOK=$(echo -e "$O" | jq -r .message)
o3=$(echo -e "$O" | jq -r .code)
echo -e "SHARE  _ code : $o3 | message :$oOK"
return
}
video(){
code=$(echo $RANDOM)
...
oOK=$(echo -e "$O" | jq -r .message)
o3=$(echo -e "$O" | jq -r .code)
echo -e "VIDEO  _ code : $o3 | message :$oOK"
return
}
news(){
...
oOK=$(echo -e "$O" | jq -r .message)
o3=$(echo -e "$O" | jq -r .code)
echo -e "NEWS   _ code : $o3 | message :$oOK"
return
}
klik(){
#74039409
...
oOK=$(echo -e "$O" | jq -r .message)
o3=$(echo -e "$O" | jq -r .code)
echo -e "KLIK   _ code : $o3 | message :$oOK"
return
}
#echo -n "UID :"; read uid
#echo -n "N ID :"; read n
...
oOK=$(echo -e "$O" | jq -r .message)
o3=$(echo -e "$O" | jq -r .code)
echo -e "ARTKL  _ code : $o3 | message :$oOK
return
}
getcoin(){
